...
<li>这是 DeepSeek 级 MoE 服务跑得起来的关键；其"可插拔、为规模而设计"的思路在第62/63课会继续展开。</li>
</ul></div>
""", "en": r"""
...
<li>This is what makes DeepSeek-scale MoE serving feasible; its "pluggable, designed-for-scale" themes continue in Lessons 62/63.</li>
</ul></div>
"""}
LESSON_48 = {"zh": r"""
