...
<li>串联：第8课吞吐/延迟取舍、第4课 prefill 计算受限 vs decode 带宽受限；下节第55课实操。</li>
</ul></div>
""", "en": r"""
...
<li>Connections: Lesson 8's throughput/latency trade-off, Lesson 4's prefill compute-bound vs decode bandwidth-bound; Lesson 55 does the hands-on next.</li>
</ul></div>
"""}
LESSON_55 = {"zh": r"""
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">docs/developer_guide/contribution_guide.md</span><span class="ln">fork → 分支 → pre-commit → 测试 → PR</span></div><pre># 1) fork on GitHub, then clone YOUR fork
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">docs/developer_guide/contribution_guide.md</span><span class="ln">fork → branch → pre-commit → test → PR</span></div><pre># 1) fork on GitHub, then clone YOUR fork
git clone https://github.com/&lt;your_user_name&gt;/sglang.git
git checkout -b my-feature
