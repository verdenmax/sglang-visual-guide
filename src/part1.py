...
<span class="kw">class</span> <span class="fn">ServerArgs</span>:
    ...
    mem_fraction_static: float = None  <span class="cm"># --mem-fraction-static：静态分配的显存占比</span>
...
<span class="kw">class</span> <span class="fn">ServerArgs</span>:
    ...
    mem_fraction_static: float = None  <span class="cm"># --mem-fraction-static: static-alloc fraction</span>
