...
<table class="t">
  ...
  <tr><td class="mono">distributed/</td><td>张量/流水线/专家并行的多卡通信</td><td>第 23、38–42 课</td></tr>
...
<table class="t">
  ...
  <tr><td class="mono">distributed/</td><td>Tensor/pipeline/expert-parallel multi-GPU communication</td><td>Lessons 23, 38–42</td></tr>
