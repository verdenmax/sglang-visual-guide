...
<div class="fig">
  <svg viewBox="0 0 800 300" role="img" aria-label="媒体经处理器转为张量并插入占位符 token，视觉编码器产出图像嵌入，在模型输入处替换占位槽，再交给 LLM">
    <text x="24" y="26" style="font-weight:700;fill:var(--muted)">媒体 → 占位符 → 编码器 → 缝合</text>
    <rect x="24" y="120" width="118" height="56" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="83" y="145" text-anchor="middle" style="font-size:12px">图像 + 文本</text>
    <text x="83" y="163" text-anchor="middle" style="fill:var(--muted);font-size:11px">提示</text>
    <line x1="142" y1="148" x2="170" y2="148" style="stroke:var(--line);stroke-width:1.5"/>
    <path d="M170 148 l-8 -4 v8 z" style="fill:var(--line)"/>
    <rect x="174" y="110" width="106" height="76" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="227" y="140" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700;font-size:12px">处理器</text>
    <text x="227" y="158" text-anchor="middle" style="fill:var(--accent-ink);font-size:11px">转张量</text>
    <text x="227" y="173" text-anchor="middle" style="fill:var(--accent-ink);font-size:11px">插占位</text>
    <path d="M280 128 C 304 110, 312 92, 330 82" style="fill:none;stroke:var(--line);stroke-width:1.5"/>
    <rect x="330" y="58" width="208" height="46" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="344" y="86" class="mono" style="font-size:11px">文</text>
    <rect x="362" y="66" width="118" height="30" rx="5" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="421" y="86" text-anchor="middle" class="mono" style="font-size:11px">&lt;image&gt; × N</text>
    <text x="500" y="86" class="mono" style="font-size:11px">文</text>
    <text x="330" y="118" style="fill:var(--muted);font-size:11px">token 流（含占位符）</text>
    <path d="M280 168 C 304 188, 312 200, 330 210" style="fill:none;stroke:var(--line);stroke-width:1.5"/>
    <rect x="330" y="200" width="118" height="44" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="389" y="227" text-anchor="middle" style="font-size:12px">视觉编码器</text>
    <line x1="448" y1="222" x2="476" y2="222" style="stroke:var(--line);stroke-width:1.5"/>
    <path d="M476 222 l-8 -4 v8 z" style="fill:var(--line)"/>
    <rect x="480" y="200" width="108" height="44" rx="8" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="534" y="227" text-anchor="middle" style="font-size:12px">图像嵌入 ×N</text>
    <path d="M538 92 C 580 104, 598 110, 612 124" style="fill:none;stroke:var(--line);stroke-width:1.5"/>
    <path d="M588 214 C 600 200, 606 192, 612 176" style="fill:none;stroke:var(--purple);stroke-width:1.5;stroke-dasharray:4 3"/>
    <rect x="610" y="120" width="120" height="60" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="670" y="146" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700;font-size:12px">模型输入</text>
    <text x="670" y="164" text-anchor="middle" style="fill:var(--accent-ink);font-size:11px">占位槽 ← 嵌入</text>
    <line x1="730" y1="150" x2="752" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <path d="M752 150 l-8 -4 v8 z" style="fill:var(--line)"/>
...
<div class="fig">
  <svg viewBox="0 0 800 250" role="img" aria-label="一行 token 嵌入：多数槽位是文本 token 嵌入，中间一段连续的占位槽被视觉编码器的图像块嵌入填充">
    <text x="24" y="26" style="font-weight:700;fill:var(--muted)">输入嵌入行：占位槽填入图像嵌入</text>
    <rect x="188" y="48" width="324" height="32" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="350" y="69" text-anchor="middle" style="font-size:12px">视觉编码器</text>
    <line x1="227" y1="80" x2="227" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="309" y1="80" x2="309" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="391" y1="80" x2="391" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="473" y1="80" x2="473" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <rect x="24" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="63" y="146" text-anchor="middle" style="font-size:12px">文本</text>
    <rect x="106" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="145" y="146" text-anchor="middle" style="font-size:12px">文本</text>
    <rect x="188" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="227" y="146" text-anchor="middle" style="font-size:12px">图块</text>
    <rect x="270" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="309" y="146" text-anchor="middle" style="font-size:12px">图块</text>
    <rect x="352" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="391" y="146" text-anchor="middle" style="font-size:12px">图块</text>
    <rect x="434" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="473" y="146" text-anchor="middle" style="font-size:12px">图块</text>
    <rect x="516" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="555" y="146" text-anchor="middle" style="font-size:12px">文本</text>
    <rect x="598" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="637" y="146" text-anchor="middle" style="font-size:12px">文本</text>
    <rect x="680" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="719" y="146" text-anchor="middle" style="font-size:12px">文本</text>
    <text x="350" y="200" text-anchor="middle" style="fill:var(--purple);font-weight:700;font-size:12px">图像块嵌入 × k</text>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/srt/multimodal/processors/base_processor.py ::BaseMultimodalProcessor</span><span class="ln">把原始媒体转成特征 + 占位符 token（各模型子类化）</span></div><pre>class BaseMultimodalProcessor(ABC):
    # turns raw media (image/audio/video) into model-ready features
    # AND inserts placeholder token ids marking where those embeddings
    # get spliced into the text token stream. One subclass per model.
    def __init__(self, hf_config, server_args, _processor, ...):
        ...
    @abstractmethod
    async def process_mm_data_async(self, ...):
        ...   # -&gt; input_ids (with placeholders) + pixel/feature tensors</pre></div>
...
<li>分发由 <span class="mono">data_embedding_funcs</span> 驱动，以 <span class="mono">Modality</span>（模态）为键，决定哪种模态用哪个编码器填其占位符。</li>
...
<div class="fig">
  <svg viewBox="0 0 800 300" role="img" aria-label="media goes through the processor to tensors and placeholder tokens, the vision encoder produces image embeddings, the placeholder slots are replaced at the model input, then handed to the LLM">
    <text x="24" y="26" style="font-weight:700;fill:var(--muted)">media → placeholders → encoder → splice</text>
    <rect x="24" y="120" width="118" height="56" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="83" y="145" text-anchor="middle" style="font-size:12px">image + text</text>
    <text x="83" y="163" text-anchor="middle" style="fill:var(--muted);font-size:11px">prompt</text>
    <line x1="142" y1="148" x2="170" y2="148" style="stroke:var(--line);stroke-width:1.5"/>
    <path d="M170 148 l-8 -4 v8 z" style="fill:var(--line)"/>
    <rect x="174" y="110" width="106" height="76" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="227" y="140" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700;font-size:12px">processor</text>
    <text x="227" y="158" text-anchor="middle" style="fill:var(--accent-ink);font-size:11px">to tensors</text>
    <text x="227" y="173" text-anchor="middle" style="fill:var(--accent-ink);font-size:11px">add slots</text>
    <path d="M280 128 C 304 110, 312 92, 330 82" style="fill:none;stroke:var(--line);stroke-width:1.5"/>
    <rect x="330" y="58" width="208" height="46" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="344" y="86" class="mono" style="font-size:11px">txt</text>
    <rect x="362" y="66" width="118" height="30" rx="5" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="421" y="86" text-anchor="middle" class="mono" style="font-size:11px">&lt;image&gt; × N</text>
    <text x="500" y="86" class="mono" style="font-size:11px">txt</text>
    <text x="330" y="118" style="fill:var(--muted);font-size:11px">token stream (with slots)</text>
    <path d="M280 168 C 304 188, 312 200, 330 210" style="fill:none;stroke:var(--line);stroke-width:1.5"/>
    <rect x="330" y="200" width="118" height="44" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="389" y="227" text-anchor="middle" style="font-size:12px">vision encoder</text>
    <line x1="448" y1="222" x2="476" y2="222" style="stroke:var(--line);stroke-width:1.5"/>
    <path d="M476 222 l-8 -4 v8 z" style="fill:var(--line)"/>
    <rect x="480" y="200" width="108" height="44" rx="8" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="534" y="227" text-anchor="middle" style="font-size:12px">img emb ×N</text>
    <path d="M538 92 C 580 104, 598 110, 612 124" style="fill:none;stroke:var(--line);stroke-width:1.5"/>
    <path d="M588 214 C 600 200, 606 192, 612 176" style="fill:none;stroke:var(--purple);stroke-width:1.5;stroke-dasharray:4 3"/>
    <rect x="610" y="120" width="120" height="60" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="670" y="146" text-anchor="middle" style="fill:var(--accent-ink);font-weight:700;font-size:12px">model input</text>
    <text x="670" y="164" text-anchor="middle" style="fill:var(--accent-ink);font-size:11px">slots ← emb</text>
    <line x1="730" y1="150" x2="752" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <path d="M752 150 l-8 -4 v8 z" style="fill:var(--line)"/>
    <rect x="756" y="124" width="38" height="52" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="775" y="154" text-anchor="middle" style="font-weight:700;font-size:12px">LLM</text>
...
<div class="fig">
  <svg viewBox="0 0 800 250" role="img" aria-label="one row of token embeddings: most slots are text-token embeddings, while a contiguous run of placeholder slots is filled by the vision encoder's image-patch embeddings">
    <text x="24" y="26" style="font-weight:700;fill:var(--muted)">input-embedding row: image embeddings fill the slots</text>
    <rect x="188" y="48" width="324" height="32" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="350" y="69" text-anchor="middle" style="font-size:12px">vision encoder</text>
    <line x1="227" y1="80" x2="227" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="309" y1="80" x2="309" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="391" y1="80" x2="391" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <line x1="473" y1="80" x2="473" y2="110" style="stroke:var(--teal);stroke-width:1.5;stroke-dasharray:4 3"/>
    <rect x="24" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="63" y="146" text-anchor="middle" style="font-size:12px">text</text>
    <rect x="106" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="145" y="146" text-anchor="middle" style="font-size:12px">text</text>
    <rect x="188" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="227" y="146" text-anchor="middle" style="font-size:12px">patch</text>
    <rect x="270" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="309" y="146" text-anchor="middle" style="font-size:12px">patch</text>
    <rect x="352" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="391" y="146" text-anchor="middle" style="font-size:12px">patch</text>
    <rect x="434" y="112" width="78" height="58" rx="6" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="473" y="146" text-anchor="middle" style="font-size:12px">patch</text>
    <rect x="516" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="555" y="146" text-anchor="middle" style="font-size:12px">text</text>
    <rect x="598" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="637" y="146" text-anchor="middle" style="font-size:12px">text</text>
    <rect x="680" y="112" width="78" height="58" rx="6" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="719" y="146" text-anchor="middle" style="font-size:12px">text</text>
    <text x="350" y="200" text-anchor="middle" style="fill:var(--purple);font-weight:700;font-size:12px">image-patch emb × k</text>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/srt/multimodal/processors/base_processor.py ::BaseMultimodalProcessor</span><span class="ln">turn raw media into features + placeholder tokens (subclassed per model)</span></div><pre>class BaseMultimodalProcessor(ABC):
    # turns raw media (image/audio/video) into model-ready features
    # AND inserts placeholder token ids marking where those embeddings
    # get spliced into the text token stream. One subclass per model.
    def __init__(self, hf_config, server_args, _processor, ...):
...
<li>Dispatch is driven by <span class="mono">data_embedding_funcs</span>, keyed by <span class="mono">Modality</span>, deciding which modality is filled by which encoder.</li>
...
<div class="fig">
  <svg viewBox="0 0 820 290" role="img" aria-label="基座权重 W 加上低秩 B·A 得到适配后的有效权重，A 与 B 的秩 r 远小于维度 d">
    <text x="28" y="34" style="font-weight:700;fill:var(--muted)">有效权重 = 基座 W + 缩放·(B·A)</text>
    <rect x="36" y="70" width="120" height="120" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="96" y="126" text-anchor="middle" style="font-weight:700">W</text>
    <text x="96" y="148" text-anchor="middle" style="fill:var(--muted);font-size:12px">d×d · 冻结</text>
    <text x="178" y="138" text-anchor="middle" style="font-size:22px;fill:var(--muted)">+</text>
    <rect x="206" y="70" width="34" height="120" rx="6" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="223" y="134" text-anchor="middle" style="font-weight:700;fill:var(--blue)">B</text>
    <text x="223" y="208" text-anchor="middle" style="fill:var(--muted);font-size:12px">d×r</text>
    <text x="258" y="138" text-anchor="middle" style="font-size:20px;fill:var(--muted)">·</text>
    <rect x="276" y="116" width="120" height="34" rx="6" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="336" y="138" text-anchor="middle" style="font-weight:700;fill:var(--teal)">A</text>
    <text x="336" y="208" text-anchor="middle" style="fill:var(--muted);font-size:12px">r×d</text>
    <text x="418" y="138" text-anchor="middle" style="font-size:22px;fill:var(--muted)">=</text>
    <rect x="446" y="70" width="128" height="120" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="510" y="126" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">W + s·(B·A)</text>
    <text x="510" y="148" text-anchor="middle" style="fill:var(--muted);font-size:12px">适配后权重</text>
    <rect x="604" y="78" width="184" height="104" rx="8" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="620" y="106" style="font-weight:700;fill:var(--amber)">秩 r ≪ d</text>
    <text x="620" y="130" style="fill:var(--ink);font-size:12px">A、B 很小 · r=8/16</text>
    <text x="620" y="152" style="fill:var(--ink);font-size:12px">每个适配器仅几 MB</text>
    <text x="620" y="172" class="mono" style="fill:var(--muted);font-size:12px">s = alpha / r</text>
  </svg>
  <div class="figcap"><b>图 1 · 基座 W + 低秩 B·A</b> — 冻结的基座权重 W（d×d）叠加一个低秩增量：B（d×r）乘 A（r×d），有效权重 = W + 缩放·(B·A)。因为秩 r ≪ d，A 与 B 极小，每个适配器只占几 MB。</div>
</div>

<p>具体算一笔账：取维度 <span class="mono">d=4096</span>、秩 <span class="mono">r=16</span>，一层 LoRA 只新增约 <span class="mono">2·4096·16 ≈ 131K</span> 个参数，而整块 <span class="mono">4096×4096</span> 矩阵有 <span class="mono">16.8M</span> 个参数——只占约 <span class="mono">0.8%</span>。缩放 <span class="mono">s = alpha/r</span>（例如 <span class="mono">32/16 = 2</span>）则控制这份增量叠加到基座上的强度。</p>
...
<div class="fig">
  <svg viewBox="0 0 820 320" role="img" aria-label="一个批次里不同请求各用不同适配器：共享基座 W·x 是一次 GEMM，按适配器分段的 B·A·x 用一次分组 GEMM 完成">
    <text x="28" y="34" style="font-weight:700;fill:var(--muted)">一个批次 · 各行各用适配器 · 分组 GEMM</text>
    <text x="28" y="64" style="fill:var(--muted);font-size:12px">批次行（请求）</text>
    <rect x="28" y="74" width="128" height="30" rx="6" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="92" y="94" text-anchor="middle" class="mono" style="font-size:12px">req1 · A</text>
    <rect x="28" y="110" width="128" height="30" rx="6" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="92" y="130" text-anchor="middle" class="mono" style="font-size:12px">req2 · B</text>
    <rect x="28" y="146" width="128" height="30" rx="6" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="92" y="166" text-anchor="middle" class="mono" style="font-size:12px">req3 · A</text>
    <rect x="28" y="182" width="128" height="30" rx="6" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="92" y="202" text-anchor="middle" class="mono" style="font-size:12px">req4 · C</text>
    <line x1="156" y1="120" x2="204" y2="120" style="stroke:var(--muted);stroke-width:1.5"/>
    <polygon points="204,120 196,116 196,124" style="fill:var(--muted)"/>
    <line x1="156" y1="200" x2="204" y2="222" style="stroke:var(--muted);stroke-width:1.5"/>
    <polygon points="204,222 195,219 199,212" style="fill:var(--muted)"/>
    <rect x="208" y="92" width="190" height="56" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="303" y="116" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">共享基座 W·x</text>
    <text x="303" y="136" text-anchor="middle" style="fill:var(--muted);font-size:12px">一次 GEMM</text>
    <rect x="208" y="166" width="190" height="126" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="303" y="186" text-anchor="middle" style="fill:var(--muted);font-size:12px">分组 GEMM · 按适配器</text>
    <rect x="222" y="196" width="162" height="26" rx="5" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="303" y="214" text-anchor="middle" class="mono" style="font-size:11px">段 A · 行 1,3</text>
    <rect x="222" y="226" width="162" height="26" rx="5" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="303" y="244" text-anchor="middle" class="mono" style="font-size:11px">段 B · 行 2</text>
    <rect x="222" y="256" width="162" height="26" rx="5" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="303" y="274" text-anchor="middle" class="mono" style="font-size:11px">段 C · 行 4</text>
    <line x1="398" y1="120" x2="450" y2="150" style="stroke:var(--muted);stroke-width:1.5"/>
    <polygon points="450,150 441,148 444,140" style="fill:var(--muted)"/>
    <line x1="398" y1="226" x2="450" y2="186" style="stroke:var(--muted);stroke-width:1.5"/>
    <polygon points="450,186 444,193 441,185" style="fill:var(--muted)"/>
    <rect x="452" y="120" width="170" height="80" rx="8" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="537" y="150" text-anchor="middle" style="font-weight:700;fill:var(--purple)">(W + B·A)·x</text>
    <text x="537" y="172" text-anchor="middle" style="fill:var(--muted);font-size:12px">每行各自结果</text>
    <text x="648" y="150" style="font-weight:700;fill:var(--ink);font-size:13px">一次内核启动</text>
    <text x="648" y="172" style="fill:var(--muted);font-size:12px">应用所有 ΔW</text>
  </svg>
  <div class="figcap"><b>图 2 · 一个批次，分组 GEMM</b> — 同一批里 req1/req3 用适配器 A、req2 用 B、req4 用 C。共享的 W·x 是一次 GEMM；各请求的 B·A·x 按适配器分成段 A/B/C，用一次分组 GEMM 同时算完，每行得到各自的 (W+B·A)·x。</div>
</div>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/srt/lora/lora.py ::LoRAAdapter</span><span class="ln">一个适配器：低秩层栈，缩放=alpha/r</span></div><pre>class LoRAAdapter(nn.Module):
    # one LoRA adapter = a stack of low-rank LoRALayers over the base.
    def __init__(self, uid, config, ..., lora_backend):
        self.uid = uid
        self.scaling = config.lora_alpha / config.r   # scales B·A
        self.layers = nn.ModuleList([...])            # per-target A,B (rank r)
    # effective weight = base_W + scaling * (B @ A)   # A,B tiny, rank r</pre></div>
...
<div class="fig">
  <svg viewBox="0 0 820 290" role="img" aria-label="Base weight W plus low-rank B·A gives the adapted effective weight; the rank r of A and B is far smaller than the dimension d">
    <text x="28" y="34" style="font-weight:700;fill:var(--muted)">effective W = base W + scaling·(B·A)</text>
    <rect x="36" y="70" width="120" height="120" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="96" y="126" text-anchor="middle" style="font-weight:700">W</text>
    <text x="96" y="148" text-anchor="middle" style="fill:var(--muted);font-size:12px">d×d · frozen</text>
    <text x="178" y="138" text-anchor="middle" style="font-size:22px;fill:var(--muted)">+</text>
    <rect x="206" y="70" width="34" height="120" rx="6" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="223" y="134" text-anchor="middle" style="font-weight:700;fill:var(--blue)">B</text>
    <text x="223" y="208" text-anchor="middle" style="fill:var(--muted);font-size:12px">d×r</text>
    ...
    <rect x="446" y="70" width="128" height="120" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="510" y="126" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">W + s·(B·A)</text>
    <text x="510" y="148" text-anchor="middle" style="fill:var(--muted);font-size:12px">adapted W</text>
    <rect x="604" y="78" width="184" height="104" rx="8" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="620" y="106" style="font-weight:700;fill:var(--amber)">rank r ≪ d</text>
    <text x="620" y="130" style="fill:var(--ink);font-size:12px">A, B tiny · r=8/16</text>
    <text x="620" y="152" style="fill:var(--ink);font-size:12px">each adapter ~few MB</text>
    <text x="620" y="172" class="mono" style="fill:var(--muted);font-size:12px">s = alpha / r</text>
  </svg>
  <div class="figcap"><b>Fig 1 · base W + low-rank B·A</b> — the frozen base weight W (d×d) plus a low-rank update: B (d×r) times A (r×d), so effective weight = W + scaling·(B·A). Because rank r ≪ d, A and B are tiny — each adapter is only a few MB.</div>
</div>

<p>Run the numbers: with dimension <span class="mono">d=4096</span> and rank <span class="mono">r=16</span>, one LoRA layer adds only about <span class="mono">2·4096·16 ≈ 131K</span> parameters, versus <span class="mono">16.8M</span> in the full <span class="mono">4096×4096</span> matrix — roughly <span class="mono">0.8%</span>. The scaling <span class="mono">s = alpha/r</span> (e.g. <span class="mono">32/16 = 2</span>) controls how strongly that delta is added onto the base.</p>
...
<div class="fig">
  <svg viewBox="0 0 820 320" role="img" aria-label="In one batch different requests use different adapters: the shared base W·x is one GEMM, and the per-adapter B·A·x is done in one grouped GEMM segmented by adapter">
    <text x="28" y="34" style="font-weight:700;fill:var(--muted)">one batch · per-row adapter · grouped GEMM</text>
    <text x="28" y="64" style="fill:var(--muted);font-size:12px">batch rows (requests)</text>
    <rect x="28" y="74" width="128" height="30" rx="6" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="92" y="94" text-anchor="middle" class="mono" style="font-size:12px">req1 · A</text>
    <rect x="28" y="110" width="128" height="30" rx="6" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="92" y="130" text-anchor="middle" class="mono" style="font-size:12px">req2 · B</text>
    ...
    <polygon points="204,222 195,219 199,212" style="fill:var(--muted)"/>
    <rect x="208" y="92" width="190" height="56" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="303" y="116" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">shared base W·x</text>
    <text x="303" y="136" text-anchor="middle" style="fill:var(--muted);font-size:12px">one GEMM</text>
    <rect x="208" y="166" width="190" height="126" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="303" y="186" text-anchor="middle" style="fill:var(--muted);font-size:12px">grouped GEMM · by adapter</text>
    <rect x="222" y="196" width="162" height="26" rx="5" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="303" y="214" text-anchor="middle" class="mono" style="font-size:11px">seg A · rows 1,3</text>
    <rect x="222" y="226" width="162" height="26" rx="5" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="303" y="244" text-anchor="middle" class="mono" style="font-size:11px">seg B · row 2</text>
    <rect x="222" y="256" width="162" height="26" rx="5" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="303" y="274" text-anchor="middle" class="mono" style="font-size:11px">seg C · row 4</text>
    <line x1="398" y1="120" x2="450" y2="150" style="stroke:var(--muted);stroke-width:1.5"/>
    <polygon points="450,150 441,148 444,140" style="fill:var(--muted)"/>
    <line x1="398" y1="226" x2="450" y2="186" style="stroke:var(--muted);stroke-width:1.5"/>
    <polygon points="450,186 444,193 441,185" style="fill:var(--muted)"/>
    <rect x="452" y="120" width="170" height="80" rx="8" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="537" y="150" text-anchor="middle" style="font-weight:700;fill:var(--purple)">(W + B·A)·x</text>
    <text x="537" y="172" text-anchor="middle" style="fill:var(--muted);font-size:12px">per-row result</text>
    <text x="648" y="150" style="font-weight:700;fill:var(--ink);font-size:13px">one kernel launch</text>
    <text x="648" y="172" style="fill:var(--muted);font-size:12px">applies all ΔW</text>
  </svg>
  <div class="figcap"><b>Fig 2 · one batch, grouped GEMM</b> — in the same batch req1/req3 use adapter A, req2 uses B, req4 uses C. The shared W·x is one GEMM; each request's B·A·x is grouped into segments A/B/C and computed together in one grouped GEMM, so every row gets its own (W+B·A)·x.</div>
</div>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/srt/lora/lora.py ::LoRAAdapter</span><span class="ln">one adapter: a stack of low-rank layers, scaling = alpha / r</span></div><pre>class LoRAAdapter(nn.Module):
    # one LoRA adapter = a stack of low-rank LoRALayers over the base.
    def __init__(self, uid, config, ..., lora_backend):
        self.uid = uid
        self.scaling = config.lora_alpha / config.r   # scales B·A
...
<div class="fig">
  <svg viewBox="0 0 780 300" role="img" aria-label="RL 闭环：SGLang 生成 rollout，训练器算 reward 与梯度，更新权重，再把新权重同步回引擎">
    <text x="20" y="28" style="font-weight:700;fill:var(--muted)">RL 闭环：生成 → 打分 → 更新 → 再生成</text>
    <rect x="40" y="60" width="200" height="60" rx="10" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="140" y="86" text-anchor="middle" style="font-weight:700">① Rollout 生成</text>
    <text x="140" y="106" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--blue)">SGLang 引擎</text>
    <rect x="540" y="60" width="200" height="60" rx="10" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="640" y="86" text-anchor="middle" style="font-weight:700">② 奖励 + 梯度</text>
    <text x="640" y="106" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--amber)">训练器</text>
    <rect x="540" y="200" width="200" height="60" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="640" y="226" text-anchor="middle" style="font-weight:700">③ 更新权重</text>
    <text x="640" y="246" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--teal)">梯度下降</text>
    <rect x="40" y="200" width="200" height="60" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="140" y="226" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">④ 同步新权重</text>
    <text x="140" y="246" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--accent-ink)">update_weights</text>
    <line x1="240" y1="90" x2="536" y2="90" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="536,90 526,85 526,95" style="fill:var(--line)"/>
    <line x1="640" y1="120" x2="640" y2="196" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="640,196 635,186 645,186" style="fill:var(--line)"/>
    <line x1="540" y1="230" x2="244" y2="230" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="244,230 254,225 254,235" style="fill:var(--line)"/>
    <line x1="140" y1="200" x2="140" y2="124" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="140,124 135,134 145,134" style="fill:var(--line)"/>
    <text x="390" y="282" text-anchor="middle" style="fill:var(--faint);font-size:12px">新权重回流，下一轮用更新后的策略采样</text>
  </svg>
  <div class="figcap"><b>图 1 · RL 闭环：rollout → 奖励+梯度 → 更新 → rollout</b> — SGLang 引擎生成 rollout 样本，训练器打分（reward）并算梯度，策略权重被更新，新权重再同步回引擎供下一轮 rollout。SGLang 是 RL 循环里的高速生成器。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 800 320" role="img" aria-label="许多命名张量打包进一个桶，一次拷贝，再重建为运行模型的活动参数">
    <text x="20" y="28" style="font-weight:700;fill:var(--muted)">许多命名张量 → 一个桶 → 一次拷贝 → 活动参数</text>
    <rect x="20" y="60" width="150" height="180" rx="10" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="95" y="80" text-anchor="middle" style="font-size:12px;fill:var(--muted)">许多命名张量</text>
    <rect x="34" y="92" width="122" height="22" rx="4" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="95" y="108" text-anchor="middle" class="mono" style="font-size:11px">q_proj.weight</text>
    <rect x="34" y="120" width="122" height="22" rx="4" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="95" y="136" text-anchor="middle" class="mono" style="font-size:11px">mlp.up.weight</text>
    <rect x="34" y="148" width="122" height="22" rx="4" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="95" y="164" text-anchor="middle" class="mono" style="font-size:11px">norm.weight</text>
    <text x="95" y="196" text-anchor="middle" style="fill:var(--faint);font-size:11px">… 成千上万个</text>
    <line x1="170" y1="150" x2="216" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="216,150 206,145 206,155" style="fill:var(--line)"/>
    <rect x="220" y="80" width="180" height="140" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="310" y="104" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">一个桶</text>
    <text x="310" y="124" text-anchor="middle" class="mono" style="font-size:11px;fill:var(--accent-ink)">FlattenedTensorBucket</text>
    <rect x="236" y="138" width="148" height="24" rx="4" style="fill:var(--panel-2);stroke:var(--accent);stroke-width:1.5"/>
    <text x="310" y="154" text-anchor="middle" class="mono" style="font-size:11px">连续 buffer</text>
    <text x="310" y="188" text-anchor="middle" style="font-size:11px;fill:var(--accent-ink)">+ 元数据(名/形/偏移)</text>
    <line x1="400" y1="150" x2="446" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="446,150 436,145 436,155" style="fill:var(--line)"/>
    <rect x="450" y="118" width="150" height="64" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="525" y="144" text-anchor="middle" style="font-weight:700">一次拷贝</text>
    <text x="525" y="166" text-anchor="middle" class="mono" style="font-size:11px;fill:var(--teal)">单次连续传输</text>
    <line x1="600" y1="150" x2="646" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="646,150 636,145 636,155" style="fill:var(--line)"/>
    <rect x="650" y="80" width="130" height="140" rx="10" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="715" y="104" text-anchor="middle" style="font-weight:700">活动参数</text>
    <text x="715" y="124" text-anchor="middle" style="font-size:11px;fill:var(--blue)">重建并写入</text>
    <text x="715" y="146" text-anchor="middle" style="font-size:11px;fill:var(--blue)">运行中的模型</text>
    <text x="715" y="186" text-anchor="middle" class="mono" style="font-size:11px">reconstruct</text>
    <text x="400" y="280" text-anchor="middle" style="fill:var(--faint);font-size:12px">少量大拷贝取代成千上万次小拷贝 → 同步更快</text>
  </svg>
  <div class="figcap"><b>图 2 · 许多命名张量 → 一个桶 → 一次拷贝 → 活动参数</b> — 权重同步把许多小的命名张量打包进一个摊平的桶（含元数据），作为单次连续拷贝高速传输，再重建并写进运行模型的活动参数——比逐个搬运成千上万个张量少得多的操作。</div>
</div>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/srt/weight_sync/tensor_bucket.py ::FlattenedTensorBucket</span><span class="ln">把多个命名张量摊平进一个桶，便于一次性同步</span></div><pre>class FlattenedTensorBucket:
    # 把许多命名张量摊平进一个 buffer（+ 元数据），
    # 让权重同步变成一次连续拷贝，而不是成千上万次小拷贝。
    def __init__(self, named_tensors=None, flattened_tensor=None, metadata=None):
        # 从 named_tensors：记录每个张量的 名字/形状/dtype/偏移，
        # 再把它们摊平后的字节打包进 self.flattened_tensor。
        ...
    def reconstruct_tensors(self):
        ...   # 把 buffer 切回原来的各个命名张量</pre></div>

<p>给个具体感觉：一个 7B 模型有<strong>几百个</strong>权重张量（每层的 q/k/v/o 投影、MLP、LayerNorm…）。逐个同步就是几百次小拷贝；用 <span class="mono">FlattenedTensorBucket</span> 打包后，这几百次小拷贝就变成<strong>少数几次大拷贝</strong>，每次 RL 更新后的权重同步因此快得多。分工依旧是那句话：<strong>SGLang 负责 rollout 生成，训练器持有梯度</strong>，两者靠这个桶高效衔接。</p>
...
<div class="fig">
  <svg viewBox="0 0 780 300" role="img" aria-label="RL loop: SGLang generates rollouts, the trainer computes reward and gradient, weights are updated, then new weights are synced back into the engine">
    <text x="20" y="28" style="font-weight:700;fill:var(--muted)">RL loop: generate → score → update → generate</text>
    <rect x="40" y="60" width="200" height="60" rx="10" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="140" y="86" text-anchor="middle" style="font-weight:700">① Rollout</text>
    <text x="140" y="106" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--blue)">SGLang engine</text>
    <rect x="540" y="60" width="200" height="60" rx="10" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="640" y="86" text-anchor="middle" style="font-weight:700">② Reward + grad</text>
    <text x="640" y="106" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--amber)">trainer</text>
    <rect x="540" y="200" width="200" height="60" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="640" y="226" text-anchor="middle" style="font-weight:700">③ Update weights</text>
    <text x="640" y="246" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--teal)">grad descent</text>
    <rect x="40" y="200" width="200" height="60" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="140" y="226" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">④ Sync weights</text>
    <text x="140" y="246" text-anchor="middle" class="mono" style="font-size:12px;fill:var(--accent-ink)">update_weights</text>
    <line x1="240" y1="90" x2="536" y2="90" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="536,90 526,85 526,95" style="fill:var(--line)"/>
    <line x1="640" y1="120" x2="640" y2="196" style="stroke:var(--line);stroke-width:1.5"/>
    ...
    <line x1="140" y1="200" x2="140" y2="124" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="140,124 135,134 145,134" style="fill:var(--line)"/>
    <text x="390" y="282" text-anchor="middle" style="fill:var(--faint);font-size:12px">new weights flow back; next rollout samples the updated policy</text>
  </svg>
  <div class="figcap"><b>Fig 1 · RL loop: rollout → reward+grad → update → rollout</b> — The SGLang inference engine generates rollout samples, the trainer scores them (reward) and computes gradients, the policy weights are updated, and the new weights are synced back into the engine for the next rollout. SGLang is the fast generator inside the RL loop.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 800 320" role="img" aria-label="Many named tensors packed into one bucket, copied once, then reconstructed into the running model's live params">
    <text x="20" y="28" style="font-weight:700;fill:var(--muted)">many named tensors → one bucket → one copy → live params</text>
    <rect x="20" y="60" width="150" height="180" rx="10" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="95" y="80" text-anchor="middle" style="font-size:12px;fill:var(--muted)">many tensors</text>
    <rect x="34" y="92" width="122" height="22" rx="4" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="95" y="108" text-anchor="middle" class="mono" style="font-size:11px">q_proj.weight</text>
    <rect x="34" y="120" width="122" height="22" rx="4" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="95" y="136" text-anchor="middle" class="mono" style="font-size:11px">mlp.up.weight</text>
    <rect x="34" y="148" width="122" height="22" rx="4" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="95" y="164" text-anchor="middle" class="mono" style="font-size:11px">norm.weight</text>
    <text x="95" y="196" text-anchor="middle" style="fill:var(--faint);font-size:11px">… thousands</text>
    <line x1="170" y1="150" x2="216" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="216,150 206,145 206,155" style="fill:var(--line)"/>
    <rect x="220" y="80" width="180" height="140" rx="10" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="310" y="104" text-anchor="middle" style="font-weight:700;fill:var(--accent-ink)">one bucket</text>
    <text x="310" y="124" text-anchor="middle" class="mono" style="font-size:11px;fill:var(--accent-ink)">FlattenedTensorBucket</text>
    <rect x="236" y="138" width="148" height="24" rx="4" style="fill:var(--panel-2);stroke:var(--accent);stroke-width:1.5"/>
    <text x="310" y="154" text-anchor="middle" class="mono" style="font-size:11px">contiguous buffer</text>
    <text x="310" y="188" text-anchor="middle" style="font-size:11px;fill:var(--accent-ink)">+ metadata (name/shape/off)</text>
    <line x1="400" y1="150" x2="446" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="446,150 436,145 436,155" style="fill:var(--line)"/>
    <rect x="450" y="118" width="150" height="64" rx="10" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="525" y="144" text-anchor="middle" style="font-weight:700">one copy</text>
    <text x="525" y="166" text-anchor="middle" class="mono" style="font-size:11px;fill:var(--teal)">single transfer</text>
    <line x1="600" y1="150" x2="646" y2="150" style="stroke:var(--line);stroke-width:1.5"/>
    <polygon points="646,150 636,145 636,155" style="fill:var(--line)"/>
    <rect x="650" y="80" width="130" height="140" rx="10" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="715" y="104" text-anchor="middle" style="font-weight:700">live params</text>
    <text x="715" y="124" text-anchor="middle" style="font-size:11px;fill:var(--blue)">reconstruct</text>
    <text x="715" y="146" text-anchor="middle" style="font-size:11px;fill:var(--blue)">into running model</text>
    <text x="715" y="186" text-anchor="middle" class="mono" style="font-size:11px">write</text>
    <text x="400" y="280" text-anchor="middle" style="fill:var(--faint);font-size:12px">a few big copies replace thousands of tiny ones → faster sync</text>
  </svg>
  <div class="figcap"><b>Fig 2 · many named tensors → one bucket → one copy → live params</b> — Weight sync packs many small named weight tensors into one flattened bucket (+metadata), transfers it as a single contiguous copy, then reconstructs and writes them into the running model's live parameters — far fewer ops than copying thousands of tensors individually.</div>
</div>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/srt/weight_sync/tensor_bucket.py ::FlattenedTensorBucket</span><span class="ln">flatten many named tensors into one bucket for a single-copy sync</span></div><pre>class FlattenedTensorBucket:
    # flatten MANY named tensors into ONE buffer (+ metadata) so a weight
    # sync is a single contiguous copy, not thousands of tiny ones.
    def __init__(self, named_tensors=None, flattened_tensor=None, metadata=None):
        # from named_tensors: record each tensor's name/shape/dtype/offset,
        # then pack their flattened bytes into self.flattened_tensor.
        ...
    def reconstruct_tensors(self):
        ...   # split the buffer back into the original named tensors</pre></div>

<p>A concrete feel: a 7B model has <strong>hundreds</strong> of weight tensors (per-layer q/k/v/o projections, MLPs, LayerNorms…). Syncing them one by one is hundreds of small copies; packing them with <span class="mono">FlattenedTensorBucket</span> turns those hundreds of small copies into <strong>a handful of big ones</strong>, so weight sync after each RL update is far faster. The division of labor stays the same: <strong>SGLang serves the rollout generation while the trainer owns the gradients</strong>, glued efficiently by this bucket.</p>
...
<div class="fig">
  <svg viewBox="0 0 800 260" role="img" aria-label="扩散推理流水线：从纯噪声潜变量出发，DiT 在提示词条件下运行 N 个去噪步，每步去掉一点噪声，最终干净潜变量经 VAE 解码成输出图像">
    <path d="M 360 104 C 360 44, 220 44, 220 104" style="fill:none;stroke:var(--teal);stroke-width:1.5;stroke-dasharray:5 5"/>
    <polygon points="220,104 213,90 227,90" style="fill:var(--teal)"/>
    <text x="290" y="38" text-anchor="middle" style="fill:var(--teal);font-size:12px">每步去掉一点噪声</text>
    <rect x="24" y="104" width="132" height="52" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="90" y="128" text-anchor="middle">纯噪声</text>
    <text x="90" y="146" text-anchor="middle" class="mono" style="fill:var(--muted)">latent</text>
    <text x="178" y="134" text-anchor="middle" style="fill:var(--muted)">→</text>
    <rect x="200" y="104" width="180" height="52" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="290" y="128" text-anchor="middle">DiT 去噪</text>
    <text x="290" y="146" text-anchor="middle" class="mono" style="fill:var(--muted)">denoise × N</text>
    <text x="403" y="134" text-anchor="middle" style="fill:var(--muted)">→</text>
    <rect x="426" y="104" width="130" height="52" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="491" y="128" text-anchor="middle">VAE 解码</text>
    <text x="491" y="146" text-anchor="middle" class="mono" style="fill:var(--muted)">latent→pixel</text>
    <text x="579" y="134" text-anchor="middle" style="fill:var(--muted)">→</text>
    <rect x="602" y="104" width="150" height="52" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="677" y="134" text-anchor="middle">输出图像</text>
    <rect x="222" y="200" width="136" height="40" rx="8" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="290" y="224" text-anchor="middle">提示词条件</text>
    <path d="M 290 200 L 290 158" style="fill:none;stroke:var(--amber);stroke-width:1.5"/>
    <polygon points="290,156 283,170 297,170" style="fill:var(--amber)"/>
  </svg>
  <div class="figcap"><b>图 1 · 噪声 → 去噪 ×N → VAE → 图像</b> — 从纯高斯噪声潜变量出发，DiT 在提示词条件下运行 N 个去噪步（每步预测并移除一点噪声），最终干净的潜变量经 VAE 一次性解码成输出图像。</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 800 300" role="img" aria-label="两种范式对比：自回归 LLM 每次前向只吐一个 token、KV 缓存随步数不断增长、长度随数据可变；扩散是固定 N 步去噪、对同一个潜变量反复精修、没有不断膨胀的 KV 缓存">
    <path d="M 24 150 L 776 150" style="fill:none;stroke:var(--line);stroke-width:1;stroke-dasharray:4 4"/>
    <text x="24" y="30" style="fill:var(--blue);font-size:13px;font-weight:700">自回归：逐 token</text>
    <rect x="40" y="48" width="96" height="36" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="88" y="71" text-anchor="middle" class="mono">前向→t1</text>
    <rect x="156" y="48" width="96" height="36" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="204" y="71" text-anchor="middle" class="mono">前向→t2</text>
    <rect x="272" y="48" width="96" height="36" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="320" y="71" text-anchor="middle" class="mono">前向→t3</text>
    <text x="392" y="72" text-anchor="middle" style="fill:var(--muted)">…</text>
    <text x="432" y="58" style="fill:var(--amber);font-size:12px">KV 缓存增长</text>
    <rect x="432" y="120" width="22" height="14" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <rect x="460" y="106" width="22" height="28" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <rect x="488" y="92" width="22" height="42" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <rect x="516" y="78" width="22" height="56" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <text x="652" y="104" text-anchor="middle" style="fill:var(--muted);font-size:12px">长度随数据变</text>
    <text x="24" y="180" style="fill:var(--teal);font-size:13px;font-weight:700">扩散：N 步去噪</text>
    <rect x="40" y="198" width="86" height="46" rx="8" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="83" y="226" text-anchor="middle">潜变量</text>
    <rect x="146" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="189" y="226" text-anchor="middle">去噪 1</text>
    <rect x="252" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="295" y="226" text-anchor="middle">去噪 2</text>
    <rect x="358" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="401" y="226" text-anchor="middle">去噪 3</text>
    <text x="466" y="226" text-anchor="middle" style="fill:var(--muted)">…</text>
    <rect x="490" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="533" y="226" text-anchor="middle">去噪 N</text>
    <text x="662" y="224" text-anchor="middle" style="fill:var(--muted);font-size:12px">N 固定 · 无 KV</text>
  </svg>
  <div class="figcap"><b>图 2 · 自回归（逐 token） vs 扩散（N 步去噪）</b> — 上半：LLM 每次前向只吐一个 token，序列变长、KV 缓存随步数不断膨胀，长度由数据决定；下半：扩散对同一个潜变量做固定 N 步去噪，没有不断增长的 KV，计算形状完全不同。</div>
</div>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/multimodal_gen/runtime/cache/teacache.py ::TeaCacheContext</span><span class="ln">TeaCache 跳步上下文：L1 变化够小就复用上一步</span></div><pre>@dataclass
class TeaCacheContext:
    # inputs to the TeaCache skip decision per diffusion (DiT) step:
    # if the accumulated L1 change stays below teacache_thresh, REUSE
    # the cached residual instead of recomputing this step.
    current_timestep: int
    num_inference_steps: int
    do_cfg: bool                    # classifier-free guidance on?
    teacache_thresh: float          # accumulated-L1 threshold to skip
    teacache_params: "TeaCacheParams"</pre></div>

<p>举个具体例子：一次 50 步的扩散生成里，越到后期相邻去噪步的差异越小，TeaCache 可能跳过其中约 20%–40% 变化低于阈值的 DiT 步——比如 50 步里跳掉 15 步、只真正算 35 步，画质几乎无损却省下可观算力。和大语言模型不同，这里的步数 N（<span class="mono">num_inference_steps</span>）是<strong>事先固定</strong>的、不随数据变长，所以<strong>没有不断膨胀的 KV 缓存</strong>，只有一个长度已知的去噪循环；TeaCache 要做的，只是判断当前 <span class="mono">current_timestep</span> 的累积 L1 变化是否低于 <span class="mono">teacache_thresh</span>，是就直接复用缓存残差、跳过这一步。</p>
...
<div class="fig">
  <svg viewBox="0 0 800 260" role="img" aria-label="Diffusion inference pipeline: start from a pure-noise latent, the DiT runs N denoise steps conditioned on the prompt, each step removes a bit of noise, and the final clean latent is decoded by a VAE into the output image">
    <path d="M 360 104 C 360 44, 220 44, 220 104" style="fill:none;stroke:var(--teal);stroke-width:1.5;stroke-dasharray:5 5"/>
    <polygon points="220,104 213,90 227,90" style="fill:var(--teal)"/>
    <text x="290" y="38" text-anchor="middle" style="fill:var(--teal);font-size:12px">each step removes a bit of noise</text>
    <rect x="24" y="104" width="132" height="52" rx="8" style="fill:var(--panel-2);stroke:var(--line);stroke-width:1.5"/>
    <text x="90" y="128" text-anchor="middle">Pure noise</text>
    <text x="90" y="146" text-anchor="middle" class="mono" style="fill:var(--muted)">latent</text>
    <text x="178" y="134" text-anchor="middle" style="fill:var(--muted)">→</text>
    <rect x="200" y="104" width="180" height="52" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="290" y="128" text-anchor="middle">DiT denoise</text>
    <text x="290" y="146" text-anchor="middle" class="mono" style="fill:var(--muted)">× N steps</text>
    <text x="403" y="134" text-anchor="middle" style="fill:var(--muted)">→</text>
    <rect x="426" y="104" width="130" height="52" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="491" y="128" text-anchor="middle">VAE decode</text>
    <text x="491" y="146" text-anchor="middle" class="mono" style="fill:var(--muted)">latent→pixel</text>
    <text x="579" y="134" text-anchor="middle" style="fill:var(--muted)">→</text>
    <rect x="602" y="104" width="150" height="52" rx="8" style="fill:var(--accent-soft);stroke:var(--accent);stroke-width:1.5"/>
    <text x="677" y="134" text-anchor="middle">Output image</text>
    <rect x="222" y="200" width="136" height="40" rx="8" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1.5"/>
    <text x="290" y="224" text-anchor="middle">prompt cond</text>
    <path d="M 290 200 L 290 158" style="fill:none;stroke:var(--amber);stroke-width:1.5"/>
    <polygon points="290,156 283,170 297,170" style="fill:var(--amber)"/>
  </svg>
  <div class="figcap"><b>Fig 1 · noise → denoise ×N → VAE → image</b> — start from a pure Gaussian-noise latent; the DiT runs N denoise steps conditioned on the prompt (each predicts and removes a bit of noise); the final clean latent is decoded by a VAE into the output image.</div>
</div>
...
<div class="fig">
  <svg viewBox="0 0 800 300" role="img" aria-label="Two paradigms contrasted: the autoregressive LLM emits one token per forward, its KV cache keeps growing with each step and the length is data-dependent; diffusion runs a fixed N denoise steps refining the same latent with no growing KV cache">
    <path d="M 24 150 L 776 150" style="fill:none;stroke:var(--line);stroke-width:1;stroke-dasharray:4 4"/>
    <text x="24" y="30" style="fill:var(--blue);font-size:13px;font-weight:700">Autoregressive: token-by-token</text>
    <rect x="40" y="48" width="96" height="36" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="88" y="71" text-anchor="middle" class="mono">fwd→t1</text>
    <rect x="156" y="48" width="96" height="36" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="204" y="71" text-anchor="middle" class="mono">fwd→t2</text>
    <rect x="272" y="48" width="96" height="36" rx="8" style="fill:var(--blue-soft);stroke:var(--blue);stroke-width:1.5"/>
    <text x="320" y="71" text-anchor="middle" class="mono">fwd→t3</text>
    <text x="392" y="72" text-anchor="middle" style="fill:var(--muted)">…</text>
    <text x="432" y="58" style="fill:var(--amber);font-size:12px">KV cache grows</text>
    <rect x="432" y="120" width="22" height="14" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <rect x="460" y="106" width="22" height="28" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <rect x="488" y="92" width="22" height="42" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <rect x="516" y="78" width="22" height="56" rx="2" style="fill:var(--amber-soft);stroke:var(--amber);stroke-width:1"/>
    <text x="656" y="104" text-anchor="middle" style="fill:var(--muted);font-size:12px">data-dependent</text>
    <text x="24" y="180" style="fill:var(--teal);font-size:13px;font-weight:700">Diffusion: N-step denoise</text>
    <rect x="40" y="198" width="86" height="46" rx="8" style="fill:var(--purple-soft);stroke:var(--purple);stroke-width:1.5"/>
    <text x="83" y="226" text-anchor="middle">latent</text>
    <rect x="146" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="189" y="226" text-anchor="middle">denoise 1</text>
    <rect x="252" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="295" y="226" text-anchor="middle">denoise 2</text>
    <rect x="358" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="401" y="226" text-anchor="middle">denoise 3</text>
    <text x="466" y="226" text-anchor="middle" style="fill:var(--muted)">…</text>
    <rect x="490" y="198" width="86" height="46" rx="8" style="fill:var(--teal-soft);stroke:var(--teal);stroke-width:1.5"/>
    <text x="533" y="226" text-anchor="middle">denoise N</text>
    <text x="664" y="224" text-anchor="middle" style="fill:var(--muted);font-size:12px">fixed N · no KV</text>
  </svg>
  <div class="figcap"><b>Fig 2 · autoregressive (token-by-token) vs diffusion (N-step denoise)</b> — top: the LLM emits one token per forward, the sequence grows and the KV cache keeps swelling, length set by the data; bottom: diffusion runs a fixed N denoise steps over the same latent with no growing KV — an entirely different compute shape.</div>
</div>
...
<div class="codefile"><div class="cf-head"><span class="dot"></span><span class="path">python/sglang/multimodal_gen/runtime/cache/teacache.py ::TeaCacheContext</span><span class="ln">TeaCache skip context: reuse the last step when the L1 change is small</span></div><pre>@dataclass
class TeaCacheContext:
    # inputs to the TeaCache skip decision per diffusion (DiT) step:
    # if the accumulated L1 change stays below teacache_thresh, REUSE
    # the cached residual instead of recomputing this step.
...
<p>A concrete example: in a 50-step diffusion run, later adjacent denoise steps differ less and less, so TeaCache may skip roughly 20%–40% of the DiT steps whose change falls below the threshold — say skipping 15 of 50 steps and truly computing only 35, with almost no quality loss yet a sizable compute saving. Unlike an LLM, the step count N here (<span class="mono">num_inference_steps</span>) is <strong>fixed up front</strong> and not data-dependent, so there is <strong>no growing KV cache</strong>, only a denoise loop of known length; all TeaCache does is check whether the accumulated L1 change at the current <span class="mono">current_timestep</span> stays below <span class="mono">teacache_thresh</span>, and if so reuse the cached residual and skip this step.</p>
